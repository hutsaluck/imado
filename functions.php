<?php
/**
 * Imado functions and definitions
 *
 ...
 */
function imado_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Imado, use a find and replace
		* to change 'imado' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'imado', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'imado' ),
		)
	);
 ...
 */
function imado_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'imado' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'imado' ),
